...
/*
 * onewire_gpio.h - 1-Wire bus provider/consumer interface
 *
...
struct onewire_bus_ops {
	unsigned char (*reset)(struct onewire_bus *bus);
	unsigned char (*read_byte)(struct onewire_bus *bus);
	void (*write_byte)(struct onewire_bus *bus, char val);

...
#define BAT_OVP_FAULT_MASK			(1U << BAT_OVP_FAULT_SHIFT)
#define BAT_OCP_FAULT_MASK			(1U << BAT_OCP_FAULT_SHIFT)
#define BUS_OVP_FAULT_MASK			(1U << BUS_OVP_FAULT_SHIFT)
#define BUS_OCP_FAULT_MASK			(1U << BUS_OCP_FAULT_SHIFT)
#define BAT_THERM_FAULT_MASK		(1U << BAT_THERM_FAULT_SHIFT)
#define BUS_THERM_FAULT_MASK		(1U << BUS_THERM_FAULT_SHIFT)
#define DIE_THERM_FAULT_MASK		(1U << DIE_THERM_FAULT_SHIFT)
...
#define BAT_OVP_ALARM_MASK		(1U << BAT_OVP_ALARM_SHIFT)
#define BAT_OCP_ALARM_MASK		(1U << BAT_OCP_ALARM_SHIFT)
#define BUS_OVP_ALARM_MASK		(1U << BUS_OVP_ALARM_SHIFT)
#define BUS_OCP_ALARM_MASK		(1U << BUS_OCP_ALARM_SHIFT)
#define BAT_THERM_ALARM_MASK		(1U << BAT_THERM_ALARM_SHIFT)
#define BUS_THERM_ALARM_MASK		(1U << BUS_THERM_ALARM_SHIFT)
#define DIE_THERM_ALARM_MASK		(1U << DIE_THERM_ALARM_SHIFT)
#define BAT_UCP_ALARM_MASK		(1U << BAT_UCP_ALARM_SHIFT)

#define VBAT_REG_STATUS_SHIFT		0
#define IBAT_REG_STATUS_SHIFT		1

#define VBAT_REG_STATUS_MASK		(1U << VBAT_REG_STATUS_SHIFT)
#define IBAT_REG_STATUS_MASK		(1U << IBAT_REG_STATUS_SHIFT)
...
static DEVICE_ATTR(registers, S_IRUGO | S_IWUSR, sc8551_show_registers, sc8551_store_register);
...
static int sc8551_suspend(struct device *dev)
{
	...
	pr_info_ratelimited("[sc8551_chg]: %s: Suspend successfully!\n", __func__);
	return 0;
}
...
static int sc8551_suspend_noirq(struct device *dev)
{
	...
	if (atomic_read(&sc->irq_disabled) || atomic_read(&sc->irq_pending)) {
		pr_err_ratelimited("[sc8551_chg]: %s: Aborting suspend_noirq: pending IRQ activity\n", __func__);
		return -EBUSY;
	}
...
static int sc8551_resume(struct device *dev)
{
	...
	pr_info_ratelimited("[sc8551_chg]: %s: Resume successfully!\n", __func__);
	return 0;
}

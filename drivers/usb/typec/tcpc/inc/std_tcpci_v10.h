 ...
 */
#define TCPC_V10_REG_ALERT_VENDOR_DEFINED		(1U << 15)
#define TCPC_V10_REG_VBUS_SINK_DISCONNECT		(1U << 11)
#define TCPC_V10_REG_RX_OVERFLOW			(1U << 10)
#define TCPC_V10_REG_ALERT_FAULT			(1U << 9)
#define TCPC_V10_REG_ALERT_LO_VOLT			(1U << 8)
#define TCPC_V10_REG_ALERT_HI_VOLT			(1U << 7)
#define TCPC_V10_REG_ALERT_TX_SUCCESS			(1U << 6)
#define TCPC_V10_REG_ALERT_TX_DISCARDED			(1U << 5)
#define TCPC_V10_REG_ALERT_TX_FAILED			(1U << 4)
#define TCPC_V10_REG_ALERT_RX_HARD_RST			(1U << 3)
#define TCPC_V10_REG_ALERT_RX_STATUS			(1U << 2)
#define TCPC_V10_REG_ALERT_POWER_STATUS			(1U << 1)
#define TCPC_V10_REG_ALERT_CC_STATUS			(1U << 0)
...
#define TCPC_V10_REG_POWER_STATUS_TCPC_INITIAL		(1U << 6)
#define TCPC_V10_REG_POWER_STATUS_SRC_HV		(1U << 5)
#define TCPC_V10_REG_POWER_STATUS_SRC_VBUS		(1U << 4)
#define TCPC_V10_REG_POWER_STATUS_VBUS_PRES_DET		(1U << 3)
#define TCPC_V10_REG_POWER_STATUS_VBUS_PRES		(1U << 2)
#define TCPC_V10_REG_POWER_STATUS_VCONN_PRES		(1U << 1)
#define TCPC_V10_REG_POWER_STATUS_SINK_VBUS		(1U << 0)
...
#define TCPC_V10_REG_FAULT_STATUS_VCONN_OV		(1U << 7)
#define TCPC_V10_REG_FAULT_STATUS_FORCE_OFF_VBUS	(1U << 6)
#define TCPC_V10_REG_FAULT_STATUS_AUTO_DISC_FAIL	(1U << 5)
#define TCPC_V10_REG_FAULT_STATUS_FORCE_DISC_FAIL	(1U << 4)
#define TCPC_V10_REG_FAULT_STATUS_VBUS_OC		(1U << 3)
#define TCPC_V10_REG_FAULT_STATUS_VBUS_OV		(1U << 2)
#define TCPC_V10_REG_FAULT_STATUS_VCONN_OC		(1U << 1)
#define TCPC_V10_REG_FAULT_STATUS_I2C_ERROR		(1U << 0)

/*
 * TCPC_V10_REG_ROLE_CTRL			(0x1A)
 */

#define TCPC_V10_REG_ROLE_CTRL_DRP			(1U << 6)
...
#define TCPC_V10_REG_TCPC_CTRL_EN_LOOK4CONNECTION_ALERT	(1U << 6)
#define TCPC_V10_REG_TCPC_CTRL_EN_WDT		(1U << 5)
#define TCPC_V10_REG_TCPC_CTRL_BIST_TEST_MODE	(1U << 1)
#define TCPC_V10_REG_TCPC_CTRL_PLUG_ORIENT	(1U << 0)

/*
 * TCPC_V10_REG_FAULT_CTRL		(0x1B)
 */

#define TCPC_V10_REG_FAULT_CTRL_DIS_VCONN_OV	(1U << 7)
#define TCPC_V10_REG_FAULT_CTRL_DIS_SNK_VBUS_OC	(1U << 2)
#define TCPC_V10_REG_FAULT_CTRL_DIS_VCONN_OC	(1U << 0)

/*
 * TCPC_V10_REG_POWER_CTRL		(0x1C)
 */

#define TCPC_V10_REG_VBUS_MONITOR		(1U << 6)
#define TCPC_V10_REG_BLEED_DISC_EN		(1U << 3)
#define TCPC_V10_REG_FORCE_DISC_EN		(1U << 2)
#define TCPC_V10_REG_POWER_CTRL_VCONN		(1U << 0)

/*
 * TCPC_V10_REG_CC_STATUS			(0x1D)
 */

#define TCPC_V10_REG_CC_STATUS_DRP_TOGGLING		(1U << 5)

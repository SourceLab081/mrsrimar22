...
#define RT1711H_REG_CLK_DIV_600K_EN	(1U << 7)
#define RT1711H_REG_CLK_BCLK2_EN	(1U << 6)
#define RT1711H_REG_CLK_BCLK2_TG_EN	(1U << 5)
#define RT1711H_REG_CLK_DIV_300K_EN	(1U << 3)
#define RT1711H_REG_CLK_CK_300K_EN	(1U << 2)
#define RT1711H_REG_CLK_BCLK_EN		(1U << 1)
#define RT1711H_REG_CLK_BCLK_TH_EN	(1U << 0)

/*
 * RT1711H_REG_CLK_CTRL3	(0x88)
 */

#define RT1711H_REG_CLK_OSCMUX_RG_EN	(1U << 7)
#define RT1711H_REG_CLK_CK_24M_EN	(1U << 6)
#define RT1711H_REG_CLK_OSC_RG_EN	(1U << 5)
#define RT1711H_REG_CLK_DIV_2P4M_EN	(1U << 4)
#define RT1711H_REG_CLK_CK_2P4M_EN	(1U << 3)
#define RT1711H_REG_CLK_PCLK_EN		(1U << 2)
#define RT1711H_REG_CLK_PCLK_RG_EN	(1U << 1)
#define RT1711H_REG_CLK_PCLK_TG_EN	(1U << 0)

/*
 * RT1711H_REG_BMC_CTRL		(0x90)
 */

#define RT1711H_REG_IDLE_EN		(1U << 6)
#define RT1711H_REG_DISCHARGE_EN	(1U << 5)
#define RT1711H_REG_BMCIO_LPRPRD	(1U << 4)
#define RT1711H_REG_BMCIO_LPEN		(1U << 3)
#define RT1711H_REG_BMCIO_BG_EN		(1U << 2)
#define RT1711H_REG_VBUS_DET_EN		(1U << 1)
#define RT1711H_REG_BMCIO_OSC_EN	(1U << 0)

/*
 * RT1711H_REG_RT_STATUS	(0x97)
 */

#define RT1711H_REG_RA_DETACH		(1U << 5)
#define RT1711H_REG_VBUS_80		(1U << 1)

/*
 * RT1711H_REG_RT_INT		(0x98)
 */

#define RT1711H_REG_INT_RA_DETACH	(1U << 5)
#define RT1711H_REG_INT_WATCHDOG	(1U << 2)
#define RT1711H_REG_INT_VBUS_80		(1U << 1)
#define RT1711H_REG_INT_WAKEUP		(1U << 0)

/*
 * RT1711H_REG_RT_MASK		(0x99)
 */

#define RT1711H_REG_M_RA_DETACH		(1U << 5)
#define RT1711H_REG_M_WATCHDOG		(1U << 2)
#define RT1711H_REG_M_VBUS_80		(1U << 1)
#define RT1711H_REG_M_WAKEUP		(1U << 0)

/*
 * RT1711H_REG_IDLE_CTRL	(0x9B)
 */

#define RT1711H_REG_CK_300K_SEL		(1U << 7)
#define RT1711H_REG_SHIPPING_OFF	(1U << 5)
#define RT1711H_REG_ENEXTMSG		(1U << 4)
#define RT1711H_REG_AUTOIDLE_EN		(1U << 3)
...
#define RT1711H_REG_IDLE_SET(ck300, ship_dis, auto_idle, tout) \
	(((ck300) << 7) | ((ship_dis) << 5) | ((auto_idle) << 3) | ((tout) & 0x07) | RT1711H_REG_ENEXTMSG)
#else
#define RT1711H_REG_IDLE_SET(ck300, ship_dis, auto_idle, tout) \
...
#define RT1711H_REG_INTRST_EN		(1U << 7)
...
#define RT1711H_REG_WATCHDOG_EN		(1U << 7)
...
#define RT1711H_REG_I2CRST_EN		(1U << 7)

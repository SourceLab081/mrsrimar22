...
#define BSDO_BAT_INFO_INVALID_REF	(1U << 0)
#define BSDO_BAT_INFO_PRESENT		(1U << 1)
...
#define ADO_ALERT_BAT_CHANGED	(1U << 1)
#define ADO_ALERT_OCP	(1U << 2)
#define ADO_ALERT_OTP	(1U << 3)
#define ADO_ALERT_OPER_CHANGED	(1U << 4)
#define ADO_ALERT_SRC_IN_CHANGED	(1U << 5)
#define ADO_ALERT_OVP	(1U << 6)
...
#define PD_SCEDB_COMPLIANCE_LPS	(1U << 0)
#define PD_SCEDB_COMPLIANCE_PS1	(1U << 1)
#define PD_SCEDB_COMPLIANCE_PS2	(1U << 2)

#define PD_SCEDB_TC_LOW_TC		(1U << 0)
#define PD_SCEDB_TC_GROUND		(1U << 1)
#define PD_SCEDB_TC_GROUND_INTEND	(1U << 2)

#define PD_SCEDB_TT_IEC_60950		0
#define PD_SCEDB_TT_IEC_62368_TS1	1
#define PD_SCEDB_TT_IEC_62368_TS2	2

#define PD_SCEDB_INPUT_EXT		(1U << 0)
#define PD_SCEDB_INPUT_EXT_UNCONSTRAINED	(1U << 1)
#define PD_SCEDB_INPUT_INT		(1U << 2)
...
#define PD_BCDB_BAT_TYPE_INVALID	(1U << 0)
...
#define PD_STATUS_INPUT_EXT_POWER	(1U << 1)
#define PD_STATUS_INPUT_EXT_POWER_FROM_AC	(1U << 2)
#define PD_STATUS_INPUT_INT_POWER_BAT		(1U << 3)
#define PD_STATUS_INPUT_INT_POWER_NOT_BAT	(1U << 4)

#define PD_STATUS_EVENT_OCP	(1U << 1)
#define PD_STATUS_EVENT_OTP	(1U << 2)
#define PD_STATUS_EVENT_OVP	(1U << 3)
#define PD_STATUS_EVENT_CF_MODE	(1U << 4)

...
#define DPM_REACTION_REQUEST_PR_SWAP		(1U << 0)
#define DPM_REACTION_REQUEST_DR_SWAP		(1U << 1)
#define DPM_REACTION_GET_SINK_CAP		(1U << 2)
#define DPM_REACTION_GET_SOURCE_CAP		(1U << 3)
#define DPM_REACTION_ATTEMPT_GET_FLAG		(1U << 4)
#define DPM_REACTION_REQUEST_VCONN_SRC	(1U << 5)
#define DPM_REACTION_RETURN_VCONN_SRC	(1U << 6)
#define DPM_REACTION_REJECT_CANCEL	(1U << 7) /* FLAG ONLY */

#define DPM_REACTION_DFP_FLOW_DELAY		(1U << 10)
#define DPM_REACTION_UFP_FLOW_DELAY		(1U << 11)
#define DPM_REACTION_VCONN_STABLE_DELAY		(1U << 12)

#define DPM_REACTION_DISCOVER_ID		(1U << 16)
#define DPM_REACTION_DISCOVER_SVID		(1U << 17)
#define DPM_REACTION_DISCOVER_CABLE		(1U << 18)
#define DPM_REACTION_DYNAMIC_VCONN		(1U << 19)
...
#define DPM_REACTION_GET_SOURCE_CAP_EXT	(1U << 24)

#define DPM_REACTION_CAP_RESET_CABLE		(1U << 28)
#define DPM_REACTION_CAP_READY_ONCE		(1U << 29)
#define DPM_REACTION_CAP_DISCOVER_CABLE	(1U << 30)
#define DPM_REACTION_CAP_ALWAYS		(1U << 31)

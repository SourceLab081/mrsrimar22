...
#define TCPC_REG_POWER_STATUS_EXT_VSAFE0V	(1U << 15) /* extend */
#define TCPC_REG_POWER_STATUS_VBUS_PRES		(1U << 2)

/* TCPC Alert Register Define */
#define TCPC_REG_ALERT_EXT_RA_DETACH		(1U << 21)
#define TCPC_REG_ALERT_EXT_WATCHDOG		(1U << 18)
#define TCPC_REG_ALERT_EXT_VBUS_80		(1U << 17)
#define TCPC_REG_ALERT_EXT_WAKEUP		(1U << 16)

#define TCPC_REG_ALERT_VBUS_DISCNCT		(1U << 11)
#define TCPC_REG_ALERT_RX_BUF_OVF		(1U << 10)
#define TCPC_REG_ALERT_FAULT			(1U << 9)
#define TCPC_REG_ALERT_V_ALARM_LO		(1U << 8)
#define TCPC_REG_ALERT_V_ALARM_HI		(1U << 7)
#define TCPC_REG_ALERT_TX_SUCCESS		(1U << 6)
#define TCPC_REG_ALERT_TX_DISCARDED		(1U << 5)
#define TCPC_REG_ALERT_TX_FAILED		(1U << 4)
#define TCPC_REG_ALERT_RX_HARD_RST		(1U << 3)
#define TCPC_REG_ALERT_RX_STATUS		(1U << 2)
#define TCPC_REG_ALERT_POWER_STATUS		(1U << 1)
#define TCPC_REG_ALERT_CC_STATUS		(1U << 0)
...
/* TCPC Behavior Flags */
#define TCPC_FLAGS_RETRY_CRC_DISCARD		(1U << 0)
#define TCPC_FLAGS_WAIT_HRESET_COMPLETE		(1U << 1) /* Always true */
#define TCPC_FLAGS_CHECK_CC_STABLE		(1U << 2)
#define TCPC_FLAGS_LPM_WAKEUP_WATCHDOG		(1U << 3)
#define TCPC_FLAGS_CHECK_RA_DETACH		(1U << 4)
#define TCPC_FLAGS_PREFER_LEGACY2		(1U << 5)
#define TCPC_FLAGS_DISABLE_LEGACY		(1U << 6)

#define TCPC_FLAGS_PD_REV30			(1U << 7)

#define TCPC_FLAGS_WATCHDOG_EN			(1U << 8)
#define TCPC_FLAGS_WATER_DETECTION		(1U << 9)
#define TCPC_FLAGS_CABLE_TYPE_DETECTION		(1U << 10)
#define TCPC_FLAGS_VCONN_SAFE5V_ONLY		(1U << 11)
#define TCPC_FLAGS_ALERT_V10			(1U << 12)
...
enum tcpm_rx_cap_type {
	TCPC_RX_CAP_SOP = (1U << 0),
	TCPC_RX_CAP_SOP_PRIME = (1U << 1),
	TCPC_RX_CAP_SOP_PRIME_PRIME = (1U << 2),
	TCPC_RX_CAP_SOP_DEBUG_PRIME = (1U << 3),
	TCPC_RX_CAP_SOP_DEBUG_PRIME_PRIME = (1U << 4),
	TCPC_RX_CAP_HARD_RESET = (1U << 5),
	TCPC_RX_CAP_CABLE_RESET = (1U << 6),
};

...
#define PE_STATE_FLAG_BACK_READY_IF_RECV_WAIT		(1U << 0)
#define PE_STATE_FLAG_BACK_READY_IF_RECV_REJECT		(1U << 1)
#define PE_STATE_FLAG_BACK_READY_IF_SR_TIMER_TOUT	(1U << 2)
#define PE_STATE_FLAG_BACK_READY_IF_TX_FAILED		(1U << 3)
#define PE_STATE_FLAG_HRESET_IF_SR_TIMEOUT		(1U << 4)
#define PE_STATE_FLAG_HRESET_IF_TX_FAILED		(1U << 5)
#define PE_STATE_FLAG_IGNORE_UNKNOWN_EVENT		(1U << 6)
#define PE_STATE_FLAG_ENABLE_SENDER_RESPONSE_TIMER	(1U << 7)
...
#define PE_STATE_FLAG_BACK_READY_IF_RECV_GOOD_CRC	(1U << 0)
#define PE_STATE_FLAG_BACK_READY_IF_DPM_ACK		(1U << 1)
#define PE_STATE_FLAG_DPM_ACK_IMMEDIATELY		(1U << 7)
...
#define VDM_STATE_FLAG_ENABLE_VDM_RESPONSE_TIMER	(1U << 0)
#define VDM_STATE_FLAG_DPM_ACK_IMMEDIATELY		(1U << 4)
#define VDM_STATE_FLAG_BACK_READY_IF_DPM_ACK		(1U << 6)
#define VDM_STATE_FLAG_BACK_READY_IF_RECV_GOOD_CRC	(1U << 7)
